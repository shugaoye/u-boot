			...
			int start_block, int end_block)
{
	...
	/* A dirty fix for goldfish port, goldfish NAND base address is 0xff016000 or 0xff017000. */
	if(chip->IO_ADDR_R != (void __iomem *)0xff017000 && chip->IO_ADDR_R != (void __iomem *)0xff016000) {
